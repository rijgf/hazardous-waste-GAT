...
> [!WARNING]
> **历史版本，请勿用于当前稿件。** 当前实际方法已确认为 PPO + Transformer，而不是 GAT。保持 20 篇总量并完成来源核验的新版清单见：[英文核心参考文献_危险废物多周期模型与PPO-Transformer.md](./英文核心参考文献_危险废物多周期模型与PPO-Transformer.md)。本文件仅保留作替换审计与版本追溯。
