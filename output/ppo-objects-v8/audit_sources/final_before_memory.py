...
def audit_trial(path,provenance=True):
    ...
    if result['checkpoint_used']:
        ...
        assert ckpt['format'] in ('full_objects_v7','conditional_objects_v8c','conditional_objects_v8f')
...
def main():
    ...
    cache={}
    for name,source in [('audit.json','audit_ppo_objects_v8.py'),('audit_final.json','audit_ppo_objects_v8_final.py')]:
        file=OUT/name
